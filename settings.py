...
from src.utilities.frames import (
    ...
    generate_cannons_frames,
    generate_shoot_frames
...
input_handler.InputHandler.set_keyboard_action(input_handler.KEY_z, "shoot")
...
TEXTURES = {
    ...
    "cannons": pygame.image.load(BASE_DIR / "assets" / "graphics" / "cannonsPower.png"),
    "shoots": pygame.image.load(BASE_DIR / "assets" / "graphics" / "shoots.png"),
}
...
FRAMES = {
    ...
    "cannons": generate_cannons_frames(),
    "shoots": generate_shoot_frames(),
}
